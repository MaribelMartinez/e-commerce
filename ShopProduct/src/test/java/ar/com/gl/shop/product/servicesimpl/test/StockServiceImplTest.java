...
class StockServiceImplTest {
	...
	void testCase_0()
	{
		Mockito.when(repositoryMock.getStock(2L)).thenReturn(stock);
	...
	void testCase_1() {
		stock.setId(5L);
		Mockito.when(repositoryMock.getStock(5L)).thenReturn(stock);
	...
	void testCase_5() {
		Mockito.when(repositoryMock.getStock(6L)).thenReturn(null);//
	...
	void testCase_9() {
		...
		Mockito.when(repositoryMock.getStock(5L)).thenReturn(null);//
		assertNull(stockService.findById(5L, true));
